...
namespace ProjectA.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(ProjectAContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var projectAContext = _context.Accounts.Include(a => a.Role);
            return View(await projectAContext.ToListAsync());
        }
